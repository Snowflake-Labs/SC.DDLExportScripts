--DROP TABLE adventureworks2012_production.transactionhistoryarchive;
CREATE OR REPLACE TABLE  adventureworks2012_production.transactionhistoryarchive		--// CREATE TABLE 
(
	transactionid INTEGER NOT NULL 		--//  ENCODE az64
