...
class TestDemoDatabase(TeradataExtractionTestBase):
    ...
    def test_database_files(self):
        self.validate_extracted_files_quantity(self.extracted_database_summary.get_count_of_files(), 20)
        self.validate_top_level_objects_quantity(TopLevelObjectType.TABLE, 9)
        self.validate_top_level_objects_quantity(TopLevelObjectType.DATABASE, 1)
