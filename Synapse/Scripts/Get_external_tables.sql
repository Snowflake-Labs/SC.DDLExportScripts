SELECT
    ...
    CHAR(13) + CHAR(10) +
    'CREATE EXTERNAL TABLE [' + s.name + '].[' + t.name + '] (' + CHAR(13) + CHAR(10) +
    STRING_AGG(
        '    [' + c.name + '] ' +
    ...
    '    LOCATION = ''' + ext_t.location + ''',' + CHAR(13) + CHAR(10) +
    '    DATA_SOURCE = [' + eds.name + '],' + CHAR(13) + CHAR(10) +
    '    FILE_FORMAT = [' + eff.name + ']' + CHAR(13) + CHAR(10) +
    ');' + CHAR(13) + CHAR(10) +
